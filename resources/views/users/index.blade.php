    ...
    <div class="container mt-5">
        <div class="card">
            <div class="card-body card-body-bg">
                <h5>Search</h5>
                <div class="mb-3">
                    <form method="GET" class="example" action="{{ route('users.list.search') }}">
                        <div class="input-group">
                            <input type="search" id="search" required class="form-control rounded" name="search" value="{{ $search ?? '' }}" placeholder="Search name/designation/department..." aria-label="Search" aria-describedby="search-addon" />
                          </div>
                    </form>
